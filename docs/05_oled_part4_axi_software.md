...
>  **Notice:** The Block Design looks different than the video's Vivado 2017.4 version

![Block Design](images/Screenshot%202026-06-29%20144420.png)
 
### Step 14: Make OLED Ports External
 
Right-click each OLED port on the `oledControlp4` block → **Make External**.

![Ports External](images/Screenshot%202026-06-29%20144740.png)
...
![Change External Name](images/Screenshot%202026-06-29%20151311.png)

### Step 15: Constraints File
 
Copy `oledControl.xdc` from the Part 3 project. Remove the `clock` and `reset` lines (now handled by the PS):
